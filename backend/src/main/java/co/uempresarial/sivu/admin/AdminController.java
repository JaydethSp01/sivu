...
public class AdminController {
    ...
    @Operation(summary = "Cargar datos demo de Coformación (usuarios, estudiantes, empresas, tutores y 1 práctica asignada). " +
        "Solo crea si no hay datos. En perfiles dev/docker el seed se ejecuta automáticamente al arrancar; " +
        "este endpoint es para re-invocar manualmente.")
