...
public class InformeFinalPmMapper {
    ...
    public InformeFinalPmResponse toResponse(InformeFinalPm i) {
        ...
        return new InformeFinalPmResponse(
            ...
            i.getReferenciasApa(),
            i.getPestelPolitico(),
            i.getPestelEconomico(),
            i.getPestelSocial(),
            i.getPestelTecnologico(),
            i.getVentajaCompetitiva(),
            i.getInternoCapacidadDirectiva(),
            i.getInternoCapacidadTecnologica(),
            i.getInternoCapacidadTecnica(),
            i.getInternoTalentoHumano(),
            i.getMetodologiaQue(),
            i.getMetodologiaComo(),
            i.getMetodologiaCuando(),
            i.getMetodologiaDonde(),
            i.getMetodologiaConQuien(),
            i.getNumeroPaginas(),
            i.getEstado(),
            i.getFechaEntrega(),
            i.getFechaRevision(),
