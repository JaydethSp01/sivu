...
import type { EvaluacionProfesorRequest, EvaluacionProfesorResponse, ParteFirmaTrimestre } from "@/lib/types";
    ...
    <div className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Pesos: Capacidades 10% · Actitudes 10% · Aplicación 80% (20/50/10)
            </p>
          </div>
        </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <Calif label="1. Capacidades y competencias (10%)" value={form.capacidades} onChange={(v) => setForm({ ...form, capacidades: v })} />
          <Calif label="2. Actitudes y comportamiento (10%)" value={form.actitudes} onChange={(v) => setForm({ ...form, actitudes: v })} />
          <div className="rounded-md border p-3 space-y-2">
            <div className="text-sm font-semibold">3. Aplicación de herramientas (80%)</div>
            <Calif label="3.1 Desempeño aplicación herramientas (20%)" value={form.aplicacionDesempeno} onChange={(v) => setForm({ ...form, aplicacionDesempeno: v })} />
            <Calif label="3.2 Calidad académica elaboración PEM (50%)" value={form.aplicacionElaboracionPem} onChange={(v) => setForm({ ...form, aplicacionElaboracionPem: v })} />
            <Calif label="3.3 Sustentación final PEM (10%)" value={form.aplicacionSustentacionPem} onChange={(v) => setForm({ ...form, aplicacionSustentacionPem: v })} />
          </div>
